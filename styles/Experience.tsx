        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              {/* Professional Process Management Graphic */}
              <div className="relative rounded-lg overflow-hidden shadow-lg">
                <ImageWithFallback 
                  src="https://images.unsplash.com/photo-1743385779347-1549dabf1320?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHByb2Nlc3MlMjBjaGFydCUyMGdyYXBofGVufDF8fHx8MTc1Nzk0MTc0OHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt="Process management workflow diagram representing operational excellence"
                  className="w-full h-64 object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
                  <p className="text-sm font-medium">Process Optimization & Workflow Management</p>
                </div>
              </div>
