...
import personalPhoto from 'figma:asset/0ae7e31821f43fda84e4bcf1f4a32451ec12077c.png';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12 mb-12">
            <div className="lg:col-span-2">
              <Card className="h-full">
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Life Balance Image */}
                  <div className="relative rounded-lg overflow-hidden shadow-md mt-6">
                    <ImageWithFallback 
                      src="https://images.unsplash.com/photo-1455994972514-4624f7f224a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjcmVhdGl2ZSUyMHdvcmtzcGFjZSUyMGJhbGFuY2UlMjBsaWZlc3R5bGV8ZW58MXx8fHwxNzU3OTQyMTU4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                      alt="Creative workspace representing the balance between professional and creative life"
                      className="w-full h-40 object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                    <div className="absolute bottom-3 left-3 text-white">
                      <p className="text-sm font-medium">The intersection of creativity and analytical thinking</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              {/* Professional Photo - Your actual portrait */}
              <div className="relative">
                <ImageWithFallback 
                  src={personalPhoto}
                  alt="Johnny Earlie - Professional portrait"
          ...
          {/* Decorative Background Section - Representing Four Life Aspects */}
          <div className="relative py-16 mb-12 -mx-4 sm:-mx-6 lg:-mx-8 overflow-hidden">
            {/* Subtle Green Gradient Background */}
            <div className="absolute inset-0 bg-gradient-to-r from-green-50/30 via-green-25/20 to-white/30"></div>
            
            {/* Very Light Decorative Elements */}
            <div className="absolute inset-0 opacity-[0.08]">
              {/* Process/Operations - Gears */}
              <div className="absolute top-8 left-8 w-20 h-20 border-2 border-green-300 rounded-full flex items-center justify-center">
                <Building2 className="w-8 h-8 text-green-400" />
              </div>
              <div className="absolute top-12 left-12 w-12 h-12 border-2 border-green-200 rounded-full"></div>
              
              {/* Music Notes */}
              <div className="absolute top-20 right-16 text-green-300">
                <Music2 className="w-12 h-12" />
              </div>
              <div className="absolute top-8 right-32 w-3 h-3 bg-green-200 rounded-full"></div>
              <div className="absolute top-16 right-24 w-2 h-2 bg-green-200 rounded-full"></div>
              
              {/* Photography Elements */}
              <div className="absolute bottom-16 left-20">
                <Camera className="w-10 h-10 text-green-300" />
              </div>
              <div className="absolute bottom-8 left-32 w-16 h-1 bg-green-200 rounded"></div>
              <div className="absolute bottom-12 left-36 w-8 h-1 bg-green-200 rounded"></div>
              
              {/* Dog/Heart Elements */}
              <div className="absolute bottom-20 right-20">
                <Heart className="w-8 h-8 text-green-300" />
              </div>
              <div className="absolute bottom-12 right-8 w-6 h-6 border-2 border-green-200 rounded-full"></div>
              
              {/* Additional subtle geometric shapes */}
              <div className="absolute top-1/2 left-1/4 w-4 h-4 bg-green-100 rounded-full"></div>
              <div className="absolute top-1/4 right-1/3 w-6 h-6 border border-green-200 rounded-full"></div>
              <div className="absolute bottom-1/3 left-1/2 w-2 h-8 bg-green-100 rounded"></div>
              <div className="absolute top-1/3 left-1/6 w-8 h-2 bg-green-100 rounded"></div>
              
              {/* Flow lines connecting elements */}
              <div className="absolute top-1/4 left-1/4 w-24 h-px bg-green-200 transform rotate-45"></div>
              <div className="absolute bottom-1/4 right-1/4 w-20 h-px bg-green-200 transform -rotate-45"></div>
              <div className="absolute top-1/2 right-1/2 w-16 h-px bg-green-200 transform rotate-12"></div>
            </div>
            
            {/* Content overlay - subtle text or quote */}
            <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-gray-900 italic">
                  "Where operations excellence meets creative expression, and personal passions fuel professional innovation."
                </p>
              </div>
            </div>
          </div>
